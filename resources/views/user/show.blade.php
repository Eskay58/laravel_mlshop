                    ...
                    <div class="md:flex md:justify-around">
                        ...
                        <div class="md:w-1/2 ml-4">
                            ...
                            <div class="flex justify-around items-center">
                                <div>
                                    <span class="title-font font-medium text-2xl text-gray-900">{{ number_format($product->price) }}</span class="text-sm text-gray-700"><span>円(税込)</span>
                                </div>
                                <form method="POST" action="{{ route('user.cart.add') }}">
                                  ...
                                  <button class="flex text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded">カートに追加</button>
